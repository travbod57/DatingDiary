...
namespace DatingDiary.Services
{
    public class DialogService
    {
        ...
        {
            // logic to stop the pop up closing during a tombstone
            Hide(e.Uri == ExternalUri || e.NavigationMode == NavigationMode.Back);
        }

        public void Hide(bool keepPopupOpen)
        {
