...
namespace DatingDiary.Google
{
		...
		public class GooglePlacesClient
		{
			...
			public void SearchForPlaceAync(GooglePlaceSearchRequest searchRequest)
			{
				...
				var requestUrl = string.Format(GooglePlacesAPI_Url, _appId, searchRequest.LocationLat.ToString(CultureInfo.InvariantCulture), searchRequest.LocationLong.ToString(CultureInfo.InvariantCulture), searchRequest.Radius, searchRequest.Sensor.ToString().ToLower(), searchRequest.Keyword, language, types);
